...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.layoutWidget.setGeometry(QRect(7, 5, 381, 151))
        ...
        self.occupation = QLineEdit(self.layoutWidget)
    ...
    def retranslateUi(self, Widget):
        ...
        self.submit.setText(QCoreApplication.translate("Widget", u"Submit", None))
    # retranslateUi
